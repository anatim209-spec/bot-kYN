    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            subcommand
                .setName("setup")
                .setDescription(
                    "انشاء لوحة تذاكر للسيرفر.",
                )
                .addChannelOption((option) =>
                    option
.setName("panel_channel")
                        .setDescription(
                            "قناة الاساسية للوحة التذاكر.",
                        )
                ...
                .addStringOption((option) =>
                    option
                        ...
                        .setDescription(
                            "الرسالة الرئيسية للوحة التذاكر.",
                        )
                        .setRequired(true),
                )
                .addStringOption((option) =>
                ...
                .addChannelOption((option) =>
                    option
                        .setName("category")
                        .setDescription(
                            "القناة التي سيتم فيها انشاء تذاكرة.",
                        )
                ...
                .addChannelOption((option) =>
                    option
                        ...
                        .setDescription(
                            "القناة التي يتم فيها اغلاق تذكرة.",
                        )
                        .addChannelTypes(ChannelType.GuildCategory)
                        .setRequired(false),
                )
                .addRoleOption((option) =>
                    option
                        .setName("staff_role")
                        .setDescription(
                            "الرتبة الادارية الرئيسية للدعم الفني.",
                        )
                        .setRequired(false),
                )
                .addIntegerOption((option) =>
                    option
                        ...
                        .setDescription("الحد الاقصى لتذاكر المستخدم")
                        .setMinValue(1)
                        .setMaxValue(20)
                        .setRequired(false),
                )
                .addBooleanOption((option) =>
                    option
                        .setName("dm_on_close")
                        .setDescription("ارسال رسالة خاصة ل اغلاق التذاكر")
                        .setRequired(false),
                ),
        )
        .addSubcommand((subcommand) =>
            subcommand
                .setName("dashboard")
                .setDescription("فتح لوحة التحكم للتذاكر"),
        ),
    category: "ticket",
